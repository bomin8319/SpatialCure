...
exp.est<-matrix(NA,nrow=nsims,ncol=44)
#history matrix for weibull estimates
weib.est<-matrix(NA,nrow=nsims,ncol=50)
#history matrix for exp RMSE
exp.rmse<-matrix(NA,nrow=nsims,ncol=22)
#history matrix for exp RMSE
weib.rmse<-matrix(NA,nrow=nsims,ncol=25)
#history matrix for exp CP
exp.cp<-matrix(NA,nrow=nsims,ncol=22)
#history matrix for exp CP
weib.cp<-matrix(NA,nrow=nsims,ncol=25)
