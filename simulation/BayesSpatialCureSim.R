...
##############
  ...
  SCExponential <- mcmcSpatialCure(Y, C, X, Z, S, A, 1100, 100, 2, form = "Exponential")
  ...
  output.SCExponential4 = summary(mcmc(SCExponential$V))
  output.SCExponential5 = summary(mcmc(SCExponential$lambda))
  ...
  exp.est[i,35]<-output.SCExponential4[[1]][1,1]
  exp.est[i,36]<-output.SCExponential4[[1]][1,4]
  exp.est[i,37]<-output.SCExponential4[[1]][2,1]
  exp.est[i,38]<-output.SCExponential4[[1]][2,4]
  exp.est[i,39]<-output.SCExponential4[[1]][3,1]
  exp.est[i,40]<-output.SCExponential4[[1]][3,4]
  exp.est[i,41]<-output.SCExponential4[[1]][4,1]
  exp.est[i,42]<-output.SCExponential4[[1]][4,4]
  exp.est[i,43]<-output.SCExponential4[[1]][5,1]
  exp.est[i,44]<-output.SCExponential4[[1]][5,4]
  
  exp.est[i,45]<-output.SCExponential5[[1]][1]
  exp.est[i,46]<-output.SCExponential5[[1]][4]
  ...
  v1.lower<-output.SCExponential4[[2]][1,1]
  v1.upper<-output.SCExponential4[[2]][1,5]
  v2.lower<-output.SCExponential4[[2]][2,1]
  v2.upper<-output.SCExponential4[[2]][2,5]
  v3.lower<-output.SCExponential4[[2]][3,1]
  v3.upper<-output.SCExponential4[[2]][3,5]
  v4.lower<-output.SCExponential4[[2]][4,1]
  v4.upper<-output.SCExponential4[[2]][4,5]
  v5.lower<-output.SCExponential4[[2]][5,1]
  v5.upper<-output.SCExponential4[[2]][5,5]
  ...
  exp.cp[i,18]<-ifelse(tru.est2[i,6]>v1.lower & tru.est2[i,6]<v1.upper, 1,0)
  exp.cp[i,19]<-ifelse(tru.est2[i,7]>v2.lower & tru.est2[i,7]<v2.upper, 1,0)
  exp.cp[i,20]<-ifelse(tru.est2[i,8]>v3.lower & tru.est2[i,8]<v3.upper, 1,0)
  exp.cp[i,21]<-ifelse(tru.est2[i,9]>v4.lower & tru.est2[i,9]<v4.upper, 1,0)
  exp.cp[i,22]<-ifelse(tru.est2[i,10]>v5.lower & tru.est2[i,10]<v5.upper, 1,0)
  exp.cp[i,23]<-ifelse(tru.est2[i,11]>l1.lower & tru.est2[i,11]<l1.upper, 1,0)
  ...
  SCWeibull <- mcmcSpatialCure(Y, C, X, Z, S, A, 1100, 100, 2, form = "Weibull")
  ...
  output.SCWeibull5 = summary(mcmc(SCWeibull$V))
  output.SCWeibull6 = summary(mcmc(SCWeibull$lambda))
  ...
  weib.est[i,41]<-output.SCWeibull5[[1]][1,1]
  weib.est[i,42]<-output.SCWeibull5[[1]][1,4]
  weib.est[i,43]<-output.SCWeibull5[[1]][2,1]
  weib.est[i,44]<-output.SCWeibull5[[1]][2,4]
  weib.est[i,45]<-output.SCWeibull5[[1]][3,1]
  weib.est[i,46]<-output.SCWeibull5[[1]][3,4]
  weib.est[i,47]<-output.SCWeibull5[[1]][4,1]
  weib.est[i,48]<-output.SCWeibull5[[1]][4,4]
  weib.est[i,49]<-output.SCWeibull5[[1]][5,1]
  weib.est[i,50]<-output.SCWeibull5[[1]][5,4]
  
  weib.est[i,51]<-output.SCWeibull6[[1]][1]
  weib.est[i,52]<-output.SCWeibull6[[1]][4]
  ...
  v1.lower<-output.SCWeibull5[[2]][1,1]
  v1.upper<-output.SCWeibull5[[2]][1,5]
  v2.lower<-output.SCWeibull5[[2]][2,1]
  v2.upper<-output.SCWeibull5[[2]][2,5]
  v3.lower<-output.SCWeibull5[[2]][3,1]
  v3.upper<-output.SCWeibull5[[2]][3,5]
  v4.lower<-output.SCWeibull5[[2]][4,1]
  v4.upper<-output.SCWeibull5[[2]][4,5]
  v5.lower<-output.SCWeibull5[[2]][5,1]
  v5.upper<-output.SCWeibull5[[2]][5,5]
  
  l1.lower<-output.SCWeibull6[[2]][1]
  l1.upper<-output.SCWeibull6[[2]][5]
  ...
  weib.cp[i,21]<-ifelse(tru.est2[i,6]>v1.lower & tru.est2[i,6]<v1.upper, 1,0)
  weib.cp[i,22]<-ifelse(tru.est2[i,7]>v2.lower & tru.est2[i,7]<v2.upper, 1,0)
  weib.cp[i,23]<-ifelse(tru.est2[i,8]>v3.lower & tru.est2[i,8]<v3.upper, 1,0)
  weib.cp[i,24]<-ifelse(tru.est2[i,9]>v4.lower & tru.est2[i,9]<v4.upper, 1,0)
  weib.cp[i,25]<-ifelse(tru.est2[i,10]>v5.lower & tru.est2[i,10]<v5.upper, 1,0)
  weib.cp[i,26]<-ifelse(tru.est2[i,11]>l1.lower & tru.est2[i,1]<l1.upper, 1,0)
